...
# download firmware
curl -fsSL http://lwfinger.com/download/rtw8852b_fw-1.bin -o "${firmware_dir}/rtw8852b_fw-1.bin"
curl -fsSL http://lwfinger.com/download/rtw8852b_fw.bin -o "${firmware_dir}/rtw8852b_fw.bin"
curl -fsSL http://lwfinger.com/download/rtw8851b_fw.bin -o "${firmware_dir}/rtw8851b_fw.bin"
curl -fsSL http://lwfinger.com/download/rtw8852a_fw.bin -o "${firmware_dir}/rtw8852a_fw.bin"
curl -fsSL http://lwfinger.com/download/rtw8852c_fw.bin -o "${firmware_dir}/rtw8852c_fw.bin"
curl -fsSL https://github.com/armbian/firmware/blob/master/rtl8852bu_fw -o "${firmware_dir}/rtl8852bu_fw.bin"
